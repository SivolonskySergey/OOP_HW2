public class CompetitionGameMain {
    ...
    public static void main(String[] args) {
        ...
        for (Participant participant : participants) {
            for (Obstacle obstacle : obstacles) {
                ...
                if (result) {
                    System.out.println("Участник #" + participant.getName() + " преодолел " + obstacle.getName());
                } else {
                    System.out.println("Участник #" + participant.getName() + " НЕ преодолел " + obstacle.getName());
                }
            }
        }
    ...
    private static Obstacle[] createObstacles() {
        return new Obstacle[] {
                ...
                new SwimPollAdapter(new SwimmingPoll(20)),
                new DiscThrowAdapter(new DiscThrow(30)),
        };
    }
